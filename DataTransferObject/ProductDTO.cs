...
namespace DataTransferObject
{
    public class ProductDTO
    {
        ...
        public ProductDTO() { }
        public ProductDTO(string productId, string productName, int productQuntity, string productUnit, string importPrice, string exportPrice, string productDescription)
        {
            _ProductId=productId;
            _ProductName=productName;
            _ProductQuntity=productQuntity;
        ...
        public int ProductQuntity { get => _ProductQuntity; set => _ProductQuntity = value; }
